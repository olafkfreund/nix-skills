...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers.md)
...
[`stdenv.mkDerivation`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv.md) (source section: Standard environment) is the most widely used build helper and serves as a basis for many others.
In addition, it offers various options to customize parts of the builds.

There is no uniform interface for build helpers.
[Trivial build helpers](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/trivial-build-helpers.chapter.md) (source section: Trivial build helpers) and [fetchers](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md) (source section: Fetchers) have various input types for convenience.
[Language- or framework-specific build helpers](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/index.md) (source section: Languages and frameworks) usually follow the style of `stdenv.mkDerivation`, which accepts an attribute set or a fixed-point function taking an attribute set.


[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md)
...
**Note**
  ...
  The [`invalidateFetcherByDrvHash`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/testers.chapter.md) (source section: `invalidateFetcherByDrvHash`) function helps prevent reusing cached derivations.
...
Definition: If `true`, saves the downloaded file to a temporary location instead of the expected Nix store location.
  ...
  See [Manipulating the content downloaded by `fetchurl`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md) (source section: Manipulating the content downloaded by `fetchurl`) to understand how to work with this attribute.
...
Definition: Specifies any [meta-attributes](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/meta.chapter.md) (source section: Meta-attributes) for the derivation returned by `fetchurl`.

  _Default value:_ `{}`.

`passthru` (Attribute Set; _optional_)
Definition: Specifies any extra [`passthru`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/passthru.chapter.md) (source section: Passthru-attributes) attributes for the derivation returned by `fetchurl`.
  Note that `fetchurl` defines [`passthru` attributes of its own](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md) (source section: Passthru outputs).
...
Definition: Additional packages needed to download the content.
  ...
  Has the same semantics as in [`nativeBuildInputs`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: `nativeBuildInputs`).
  See [Manipulating the content downloaded by `fetchurl`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md) (source section: Manipulating the content downloaded by `fetchurl`) to understand how this can be used with `postFetch`.
...
Despite its name, `fetchzip` is not limited to `.zip` files but can also be used with [various compressed tarball formats](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: Tar files) by default.
This can be extended by specifying additional attributes, see [Using `fetchzip` to decompress a `.rar` file](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md) (source section: Using `fetchzip` to decompress a `.rar` file) to understand how to do that.
...
Definition: If `true`, the decompressed contents are moved one level up the directory tree.
  ...
  [Using `fetchzip` to output contents directly](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/fetchers.chapter.md) (source section: Using `fetchzip` to output contents directly) shows what this attribute does.
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/trivial-build-helpers.chapter.md)
...
`derivationArgs` (Attribute set *or* [function from `finalAttrs`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/trivial-build-helpers.chapter.md) (source section: Arguments with finalAttrs))
Definition: Additional parameters passed to [`mkDerivation`]

`buildCommand` (String *or* [function from `finalAttrs`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/trivial-build-helpers.chapter.md) (source section: Arguments with finalAttrs))
...
Definition: Inputs to add to the shell script's `$PATH` at runtime.
  ...
  Each elements can either be a normal derivation, or a string containing a path, in which case it will be suffixed with `/bin` to create a `PATH` expression (see [`lib.strings.makeBinPath`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/lib/strings.nix) (source section: lib.strings.makeBinPath) for more information).
...
Definition: `stdenv.mkDerivation`'s [`meta`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/meta.chapter.md) (source section: Meta-attributes) argument

`passthru` (Attribute set, _optional_)

Definition: `stdenv.mkDerivation`'s [`passthru`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/passthru.chapter.md) (source section: Passthru-attributes) argument

`derivationArgs` (Attribute set, _optional_)

Definition: Extra arguments to pass to [`stdenv.mkDerivation`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: The Standard Environment)
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/build-helpers/special/mkshell.section.md)
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/python.section.md)
...
* In the [`buildPhase`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: The build phase), it calls `${python.pythonOnBuildForHost.interpreter} -m build --wheel` to
...
* In the [`postFixup`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: `postFixup`) phase, the `wrapPythonPrograms` bash function is called to
  wrap all programs in the `$out/bin/*` directory to include `$PATH`
  environment variable and add dependent libraries to script's `sys.path`.
* In the [`installCheck`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: The installCheck phase) phase, `${python.interpreter} -m pytest` is run.

By default tests are run because [`doCheck = true`](packaging.md#var-stdenv-doCheck). Test dependencies, like
e.g. the test runner, should be added to [`nativeCheckInputs`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/stdenv/stdenv.chapter.md) (source section: `nativeCheckInputs`).
...
modules. For that reason, when adding this package to a [`python.buildEnv`](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/python.section.md) (source section: `python.buildEnv` function), the
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/javascript.section.md)
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/go.section.md)
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/rust.section.md)
...
and importing it as described in the [next section](https://github.com/NixOS/nixpkgs/blob/d4bff64ad63ff84484ef2204c1328924725c1c82/doc/languages-frameworks/rust.section.md) (source section: Importing a `Cargo.lock` file).
