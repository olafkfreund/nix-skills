...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md)
...
- [`doc`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/doc/README.md): Sources and infrastructure for the [Nixpkgs manual](https://nixos.org/manual/nixpkgs/stable/)
- [`lib`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/lib/README.md): Sources and documentation of the [library functions](https://nixos.org/manual/nixpkgs/stable/#chap-functions)
- [`maintainers`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/maintainers/README.md): Nixpkgs maintainer and team listings, maintainer scripts
- [`nixos`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/nixos/README.md): Implementation of [NixOS](https://nixos.org/manual/nixos/stable/)
- [`pkgs`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md): Package and [builder](https://nixos.org/manual/nixpkgs/stable/#part-builders) definitions
...
> [!Note]
> Be aware that contributing implies licensing those contributions under the terms of [COPYING](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/COPYING), an MIT-like license.
...
1. Select the appropriate [base branch](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-branches#working-with-branches) for the change, as [described here](#contributing-branch-conventions).
   ...
   This can be changed later by [rebasing](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#rebasing-between-branches-ie-from-master-to-staging).
...
3. Make your changes in the local Nixpkgs repository and:
   - Adhere to both the [general code conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#code-conventions), and the relevant [specific code conventions](#contributing-overview).
   - Test the changes.
...
6. [Create a pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request#creating-the-pull-request) from the new branch in your Nixpkgs fork to the upstream Nixpkgs repository.
   ...
   Go through the [pull request template](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#pull-request-template).
...
7. Respond to review comments and potentially to CI failures and merge conflicts by updating the PR.
   ...
   The non-technical side of this process is covered in [I opened a PR, how do I get it merged?](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#i-opened-a-pr-how-do-i-get-it-merged).
   ...
   - If you need to change the base branch, [rebase](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#rebasing-between-branches-ie-from-master-to-staging).

8. If your PR is merged and [acceptable for releases](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#changes-acceptable-for-releases), you may [backport](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#how-to-backport-pull-requests) it.
...
Is the change [acceptable for releases](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#changes-acceptable-for-releases) and do you wish to have the change in the release?
...
- Yes: Can the change be implemented the same way on the `master` and release branches?
  ...
  - Yes: Use the `master` branch and [backport the pull request](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#how-to-backport-pull-requests).
  - No: Create separate pull requests to the `master` and `release-YY.MM` branches.

If the change causes a [mass rebuild](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#changes-causing-mass-rebuilds), use the `staging` branch instead:
- Mass rebuilds to `master` should go to `staging` instead.
- Mass rebuilds to `release-YY.MM` should go to `staging-YY.MM` instead.

See [this section](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#staging) for how such changes propagate between the branches.
...
These PRs go to `staging-nixos`, see [the next section for more context](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#changes-rebuilding-all-nixos-tests).
...
- When adding yourself to `maintainer-list.nix`, make a separate commit with the message `maintainers: add <handle>`.
  ...
  See [Nixpkgs Maintainers](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/maintainers/README.md) for details.

- Make sure you read about any commit conventions specific to the area you're touching.
  See:
  - [Commit conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/doc/README.md#commit-conventions) for changes to `doc`, the Nixpkgs manual.
  - [Commit conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/lib/README.md#commit-conventions) for changes to `lib`.
  - [Commit conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/nixos/README.md#commit-conventions) for changes to `nixos`.
  - [Commit conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md#commit-conventions) for changes to `pkgs`.
...
CI [enforces](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/.github/workflows/lint.yml) all Nix files to be formatted using the [official Nix formatter](https://github.com/NixOS/nixfmt).
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md)
...
2. Create a package directory `pkgs/by-name/so/some-package` where `some-package` is the package name and `so` is the lowercased 2-letter prefix of the package name:
   ...
   For more detailed information, see [here](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/README.md).
...
3. Create a `package.nix` file in the package directory, containing a Nix expression — a piece of code that describes how to build the package.
   ...
   You can have a look at the existing Nix expressions under `pkgs/` to see how it’s done, some of which are also using the [category hierarchy](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md#category-hierarchy).
   Here are some good ones:

   - GNU Hello: [`pkgs/by-name/he/hello/package.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/he/hello/package.nix).
     Trivial package, which specifies some `meta` attributes which is good practice.

   - GNU cpio: [`pkgs/by-name/cp/cpio/package.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/cp/cpio/package.nix).
     Also a simple package.
     The generic builder in `stdenv` does everything for you.
     It has no dependencies beyond `stdenv`.

   - GNU Multiple Precision arithmetic library (GMP): [`pkgs/development/libraries/gmp`](https://github.com/NixOS/nixpkgs/tree/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/development/libraries/gmp).
     Also done by the generic builder, but has a dependency on `m4`.

   - Pan, a GTK-based newsreader: [`pkgs/by-name/pa/pan/package.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/pa/pan/package.nix).
     Has an optional dependency on `gspell`, which is only built if `spellCheck` is `true`.

   - Apache HTTPD: [`pkgs/servers/http/apache-httpd/2.4.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/servers/http/apache-httpd/2.4.nix).
     A bunch of optional features, variable substitutions in the configure flags, a post-install hook, and miscellaneous hackery.

   - buildMozillaMach: [`pkgs/build-support/build-mozilla-mach/default.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/build-support/build-mozilla-mach/default.nix).
     A reusable build function for Firefox, Thunderbird and Librewolf.

   - JDiskReport, a Java utility: [`pkgs/by-name/jd/jdiskreport/package.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/jd/jdiskreport/package.nix).
     Nixpkgs doesn’t have a decent `stdenv` for Java yet so this is pretty ad-hoc.

   - XML::Simple, a Perl module: [`pkgs/top-level/perl-packages.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/top-level/perl-packages.nix) (search for the `XMLSimple` attribute).
   ...
   - Discord Game SDK: [`pkgs/by-name/di/discord-gamesdk/package.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/di/discord-gamesdk/package.nix).
   ...
   - Add yourself as the maintainer of the package.
     ...
     - If this is your first time contributing (welcome!), [add yourself to the maintainers list](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/maintainers/README.md#how-to-become-a-maintainer) in a separate commit.
...
- Make sure you read about the [commit conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#commit-conventions) common to Nixpkgs as a whole.
...
- The attribute name used for the package in the [`pkgs/by-name` structure](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/README.md) or in [`all-packages.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/top-level/all-packages.nix), and when passing it as a dependency in recipes.
...
[Upstream source](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/README.md)

# Name-based package directories

The structure of this directory maps almost directly to top-level package attributes.
Add new top-level packages to Nixpkgs using this mechanism [whenever possible](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/README.md#limitations).

Packages found in the name-based structure are automatically included, without needing to be added to `all-packages.nix`. However if the implicit attribute defaults need to be changed for a package, this [must still be declared in `all-packages.nix`](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/README.md#changing-implicit-attribute-defaults).
...
See the [general package conventions](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md#conventions) for more information on package definitions.
...
Most packages are still defined in `all-packages.nix` and the [category hierarchy](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md#category-hierarchy).
...
Since [only PRs to packages in `pkgs/by-name` can be automatically merged](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/CONTRIBUTING.md#how-to-merge-pull-requests-yourself),
...
See also [changing implicit attribute defaults](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/by-name/README.md#changing-implicit-attribute-defaults).
...
- Only packages defined using `pkgs.callPackage`.
  ...
  - Or use the [category hierarchy](https://github.com/NixOS/nixpkgs/blob/f7f73ce248a33fac06d2754ec43bd84c73ad9ed3/pkgs/README.md#category-hierarchy).
