...
if __name__ == '__main__':
    ...
    parser.add_argument('--skill', choices=['nix-language', 'devenv-project', 'nixpkgs-development', 'nixos-wiki', 'home-manager', 'microvm-nix', 'nix-darwin', 'nixos-operations'], required=True)
