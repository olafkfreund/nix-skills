...
- [Narrow the update token](how-to/update-token.md)

# Reference

- [Skill catalog](reference/catalog.md)
- [Home Manager module options](reference/options.md)
- [Update schedule](reference/update-schedule.md)
- [Nix style rules](reference/nix-style.md)

# Explanation

- [Why skills](explanation/why-skills.md)
